...
class Hook extends IPlugin {
    ...
    public function install($form=[]) {
        $this->pos('controller\Upload')->before = ['plugin\simplemde\Editor','before'];
        $this->pos('themes/add.htm')->richEditor = ['plugin\simplemde\Editor','render'];
        $this->pos('controller\Comment')->insert = ['plugin\simplemde\Editor','insert'];
        $this->conf($form);
